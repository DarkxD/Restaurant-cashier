        ...
        <div class="content">
            <div class="orders">
                ...
                <div class="orders-footer">
                    <button class="button greenprint-invoice btn btn-success print-invoice" data-client-id="{{ $client->id }}">Nyugta nyomtatása</button>
                    @include('printreceipt_modal')
                    {{-- <button class="button greenprint-invoice" id="printReceipt" onClick="printReceiptContent('invoice-POS', {{ $invoice->id }})">Nyomtatás</button> --}}
